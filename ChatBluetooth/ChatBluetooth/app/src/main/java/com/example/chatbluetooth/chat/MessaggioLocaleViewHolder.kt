...
// Messaggio.MessaggioLocale all'interno di una RecyclerView
class MessaggioLocaleViewHolder(view: View) : RecyclerView.ViewHolder(view){
    ...
    // Metodo che associa i dati di un oggetto MessaggioLocale alla view del ViewHolder
    fun bind(messaggio: Messaggio.MessaggioLocale) {
